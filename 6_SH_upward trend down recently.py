...
def trend_scoring_system(df):
    ...
    reasons.append("MA20 > MA30" if condition2 else "MA20 <= MA30")
...
if __name__ == "__main__":
    ...
    if selected_stocks:
        ...
        # 保存为Excel文件
        output_path = "C:/Users/ZJH/Documents/浙江广电-前端开发项目/QuantitativeResearch/upward_trend_down_recently.xlsx"
